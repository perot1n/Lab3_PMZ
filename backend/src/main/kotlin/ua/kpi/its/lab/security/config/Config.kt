...
@Configuration
@ComponentScan(basePackages = ["ua.kpi.its.lab.security"])
@EnableJpaRepositories(basePackages = ["ua.kpi.its.lab.security.repo"])
...
class Config {
    ...
    fun entityManagerFactory(dataSource: DataSource) =
        LocalContainerEntityManagerFactoryBean().apply {
            ...
            setPackagesToScan("ua.kpi.its.lab.security.entity")
